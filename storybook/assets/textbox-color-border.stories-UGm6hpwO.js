import{y as p}from"./preact.module-Cko36Lti.js";import{p as o}from"./create-component-B1Y1oDBF.js";import{u as j}from"./use-initial-focus-DfmxErEH.js";import{T as s}from"./textbox-color-BlJN2yT-.js";import{M as O}from"./mixed-values-hkF2bnrF.js";import"./create-class-name-irFPZBOU.js";import"./get-current-from-ref-J2nPd355.js";import"./no-op-DX6rZLP_.js";import"./raw-textbox-numeric-CcC1lQEj.js";import"./compute-next-value-cPEw4eRZ.js";import"./is-keycode-character-generating-C88G8DHI.js";const oe={tags:["2"],title:"Components/Textbox Color/Border"},i=function(){const[t,r]=o(""),[a,c]=o("");function l(n){const e=n.currentTarget.value;console.log(e),r(e)}function u(n){const e=n.currentTarget.value;console.log(e),c(e)}return p(s,{hexColor:t,onHexColorInput:l,onOpacityInput:u,opacity:a,variant:"border"})},x=function(){const[t,r]=o(""),[a,c]=o("");function l(n){const e=n.currentTarget.value;console.log(e),r(e)}function u(n){const e=n.currentTarget.value;console.log(e),c(e)}return p(s,{...j(),hexColor:t,onHexColorInput:l,onOpacityInput:u,opacity:a,variant:"border"})},C=function(){const[t,r]=o(""),[a,c]=o("");function l(n){const e=n.currentTarget.value;console.log(e),r(e)}function u(n){const e=n.currentTarget.value;console.log(e),c(e)}return p(s,{hexColor:t,hexColorPlaceholder:"Color",onHexColorInput:l,onOpacityInput:u,opacity:a,opacityPlaceholder:"%",variant:"border"})},y=function(){const[t,r]=o("0D99FF"),[a,c]=o("100%");function l(n){const e=n.currentTarget.value;console.log(e),r(e)}function u(n){const e=n.currentTarget.value;console.log(e),c(e)}return p(s,{hexColor:t,onHexColorInput:l,onOpacityInput:u,opacity:a,variant:"border"})},d=function(){const[t,r]=o("0D99FF"),[a,c]=o("100%");function l(n){const e=n.currentTarget.value;console.log(e),r(e)}function u(n){const e=n.currentTarget.value;console.log(e),c(e)}return p(s,{disabled:!0,hexColor:t,onHexColorInput:l,onOpacityInput:u,opacity:a,variant:"border"})},I=function(){const[t,r]=o(O),[a,c]=o(O);function l(n){const e=n.currentTarget.value;console.log(e),r(e)}function u(n){const e=n.currentTarget.value;console.log(e),c(e)}return p(s,{hexColor:t,onHexColorInput:l,onOpacityInput:u,opacity:a,variant:"border"})},g=function(){const[t,r]=o("0D99FF"),[a,c]=o("100%");function l(n){const e=n.currentTarget.value;console.log(e),r(e)}function u(n){const e=n.currentTarget.value;console.log(e),c(e)}return p(s,{hexColor:t,onHexColorInput:l,onOpacityInput:u,opacity:a,revertOnEscapeKeyDown:!0,variant:"border"})},H=function(){const[t,r]=o("0D99FF"),[a,c]=o("100%");function l(n){console.log(n)}function u(n){console.log(n)}return p(s,{hexColor:t,onHexColorValueInput:r,onOpacityNumericValueInput:u,onOpacityValueInput:c,onRgbaColorValueInput:l,opacity:a,variant:"border"})};var v,h,m;i.parameters={...i.parameters,docs:{...(v=i.parameters)==null?void 0:v.docs,source:{originalSource:`function () {
...
}`,...(A=(B=H.parameters)==null?void 0:B.docs)==null?void 0:A.source}}};const te=["Empty","Focused","Placeholder","Filled","Disabled","Mixed","RevertOnEscapeKeyDown","OnValueInput"];export{d as Disabled,i as Empty,y as Filled,x as Focused,I as Mixed,H as OnValueInput,C as Placeholder,g as RevertOnEscapeKeyDown,te as __namedExportsOrder,oe as default};
