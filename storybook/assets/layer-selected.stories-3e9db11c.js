import{h as c}from"./hooks.module-7c0d6ca2.js";import{u as _}from"./use-initial-focus-e560a4b5.js";import{I as l}from"./icon-layer-frame-16-ee54d065.js";import{L as u}from"./layer-f1dae559.js";import{o as n}from"./jsxRuntime.module-3e32d480.js";import"./preact.module-bf16abf2.js";import"./create-icon-cfa00594.js";import"./create-class-name-71c46838.js";const Q={parameters:{fixedWidth:!0,order:2},title:"Components/Layer/Selected"},i=function(){const[t,a]=c(!0);function o(r){const e=r.currentTarget.checked;console.log(e),a(e)}return n(u,{icon:n(l,{}),onChange:o,value:t,children:"Text"})},d=function(){const[t,a]=c(!0);function o(r){const e=r.currentTarget.checked;console.log(e),a(e)}return n(u,{..._(),icon:n(l,{}),onChange:o,value:t,children:"Text"})},g=function(){const[t,a]=c(!0);function o(r){const e=r.currentTarget.checked;console.log(e),a(e)}return n(u,{bold:!0,description:"Description",icon:n(l,{}),onChange:o,value:t,children:"Text"})},h=function(){const[t,a]=c(!0);function o(r){const e=r.currentTarget.checked;console.log(e),a(e)}return n(u,{description:"Description",icon:n(l,{}),onChange:o,value:t,children:"Text"})},p=function(){const t=Array(100).fill("Text").join(" "),[a,o]=c(!0);function r(e){const s=e.currentTarget.checked;console.log(s),o(s)}return n(u,{icon:n(l,{}),onChange:r,value:a,children:t})},m=function(){const t=Array(100).fill("Text").join(" "),a=Array(100).fill("Text").join(" "),[o,r]=c(!0);function e(s){const T=s.currentTarget.checked;console.log(T),r(T)}return n(u,{description:a,icon:n(l,{}),onChange:e,value:o,children:t})},V=function(){const t=Array(100).fill("Text").join(" "),[a,o]=c(!0);function r(e){console.log(e),o(e)}return n(u,{icon:n(l,{}),onValueChange:r,value:a,children:t})};var v,f,C;i.parameters={...i.parameters,docs:{...(v=i.parameters)==null?void 0:v.docs,source:{originalSource:`function () {
...
//# sourceMappingURL=layer-selected.stories-3e9db11c.js.map
