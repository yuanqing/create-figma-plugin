...
}`,...(R=(E=v.parameters)==null?void 0:E.docs)==null?void 0:R.source}}};var O,A,I;p.parameters={...p.parameters,docs:{...(O=p.parameters)==null?void 0:O.docs,source:{originalSource:`function () {
  const options: Array<RadioButtonsOption> = [{
    children: <Text>foo</Text>,
    value: 'foo'
  }, {
...
}`,...(I=(A=p.parameters)==null?void 0:A.docs)==null?void 0:I.source}}};var y,D,M;f.parameters={...f.parameters,docs:{...(y=f.parameters)==null?void 0:y.docs,source:{originalSource:`function () {
  const [value, setValue] = useState<string>('bar');
  const options: Array<RadioButtonsOption> = [{
    children: <Text>foo</Text>,
    value: 'foo'
