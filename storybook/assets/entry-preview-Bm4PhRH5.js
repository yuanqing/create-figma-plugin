import{y as m,p as y,g as $,N as h}from"./preact.module-Cko36Lti.js";function w(r){for(var e=[],t=1;t<arguments.length;t++)e[t-1]=arguments[t];var n=Array.from(typeof r=="string"?[r]:r);n[n.length-1]=n[n.length-1].replace(/\r?\n([\t ]*)$/,"");var u=n.reduce(function(o,f){var s=f.match(/\n([\t ]+|(?!\s).)/g);return s?o.concat(s.map(function(p){var i,c;return(c=(i=p.match(/[\t ]/g))===null||i===void 0?void 0:i.length)!==null&&c!==void 0?c:0})):o},[]);if(u.length){var d=new RegExp(`
