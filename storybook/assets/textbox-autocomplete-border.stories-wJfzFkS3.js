import{h as s}from"./create-component-a83A1_Pu.js";import{u as ve}from"./use-initial-focus-xmfxIugy.js";import{I as ie}from"./icon-layer-frame-16-sVAwYanE.js";import{T as l}from"./textbox-autocomplete-ON4sHUkZ.js";import{u as r}from"./jsxRuntime.module-mP9ZGqev.js";import"./preact.module-pS-_M4k6.js";import"./create-icon-prVyFgUx.js";import"./use-mouse-down-outside-sDCyQFx-.js";import"./get-current-from-ref-KzY6_NOj.js";import"./icon-menu-checkmark-checked-16-YiEcMcv9.js";import"./create-class-name-gq91Tlk7.js";import"./no-op-Uu3q6ZSj.js";import"./constants-TQdAxsXB.js";import"./compute-next-value-v04i_0LO.js";import"./is-keycode-character-generating-0Qf6Kf4s.js";import"./textbox.module-SUUSsoq6.js";const ze={parameters:{fixedWidth:!0},tags:["2"],title:"Components/Textbox Autocomplete/Border"},c=function(){const[n,t]=s(""),a=[{value:"foo"},{value:"bar"},{value:"baz"},"-",{header:"Header"},{value:"qux"}];function u(o){const e=o.currentTarget.value;console.log(e),t(e)}return r(l,{onInput:u,options:a,value:n,variant:"border"})},p=function(){const[n,t]=s(""),a=[{value:"foo"},{value:"bar"},{value:"baz"},"-",{header:"Header"},{value:"qux"}];function u(o){const e=o.currentTarget.value;console.log(e),t(e)}return r(l,{...ve(),onInput:u,options:a,value:n,variant:"border"})},v=function(){const[n,t]=s(""),a=[{value:"foo"},{value:"bar"},{value:"baz"},"-",{header:"Header"},{value:"qux"}];function u(o){const e=o.currentTarget.value;console.log(e),t(e)}return r(l,{onInput:u,options:a,placeholder:"Placeholder",value:n,variant:"border"})},i=function(){const[n,t]=s("foo"),a=[{value:"foo"},{value:"bar"},{value:"baz"},"-",{header:"Header"},{value:"qux"}];function u(o){const e=o.currentTarget.value;console.log(e),t(e)}return r(l,{onInput:u,options:a,value:n,variant:"border"})},d=function(){const n=[{value:"foo"},{value:"bar"},{value:"baz"},"-",{header:"Header"},{value:"qux"}];function t(){throw new Error("This function should not be called")}return r(l,{disabled:!0,onInput:t,options:n,value:"foo",variant:"border"})},m=function(){const[n,t]=s("foo"),a=[{value:"foo"},{disabled:!0,value:"bar"},{value:"baz"},"-",{header:"Header"},{value:"qux"}];function u(o){const e=o.currentTarget.value;console.log(e),t(e)}return r(l,{onInput:u,options:a,value:n,variant:"border"})},b=function(){const[n,t]=s("foo"),a=[{value:"foo"},{value:"bar"},{value:"baz"},"-",{header:"Header"},{value:"qux"}];function u(o){const e=o.currentTarget.value;console.log(e),t(e)}return r(l,{icon:r(ie,{}),onInput:u,options:a,value:n,variant:"border"})},f=function(){const[n,t]=s("foo"),a=[{value:"foo"},{value:"bar"},{value:"baz"},"-",{header:"Header"},{value:"qux"}];function u(o){const e=o.currentTarget.value;console.log(e),t(e)}return r(l,{icon:"W",onInput:u,options:a,value:n,variant:"border"})},V=function(){const[n,t]=s("foo"),a=[{value:"foo"},{value:"bar"},{value:"baz"},"-",{header:"Header"},{value:"qux"}];function u(o){const e=o.currentTarget.value;console.log(e),t(e)}return r(l,{onInput:u,options:a,revertOnEscapeKeyDown:!0,value:n,variant:"border"})},x=function(){const[n,t]=s("foo"),a=[{value:"foo"},{value:"bar"},{value:"baz"},"-",{header:"Header"},{value:"qux"}];function u(o){const e=o.currentTarget.value;console.log(e),t(e)}return r(l,{onInput:u,options:a,strict:!0,value:n,variant:"border"})},I=function(){const[n,t]=s("foo"),a=[{value:"foo"},{value:"bar"},{value:"baz"},"-",{header:"Header"},{value:"qux"}];function u(o){const e=o.currentTarget.value;console.log(e),t(e)}return r(l,{filter:!0,onInput:u,options:a,value:n,variant:"border"})},g=function(){const[n,t]=s("foo"),a=[{value:"foo"},{value:"bar"},{value:"baz"},"-",{header:"Header"},{value:"qux"}];function u(o){const e=o.currentTarget.value;console.log(e),t(e)}return r(l,{filter:!0,onInput:u,options:a,strict:!0,value:n,variant:"border"})},T=function(){const[n,t]=s("foo"),a=[{value:"foo"},{value:"bar"},{value:"baz"},"-",{header:"Header"},{value:"qux"}];function u(o){const e=o.currentTarget.value;console.log(e),t(e)}return r(l,{onInput:u,options:a,top:!0,value:n,variant:"border"})},h=function(){const[n,t]=s("foo"),a=[{value:"foo"},{value:"bar"},{value:"baz"},"-",{header:"Header"},{value:"qux"}];function u(o){console.log(o),t(o)}return r(l,{onValueInput:u,options:a,value:n,variant:"border"})};var w,A,S;c.parameters={...c.parameters,docs:{...(w=c.parameters)==null?void 0:w.docs,source:{originalSource:`function () {
