import{y as r}from"./preact.module-Cko36Lti.js";import{p as o,F as ue}from"./create-component-B1Y1oDBF.js";import{u as ae}from"./use-initial-focus-DfmxErEH.js";import{T as l}from"./textbox-multiline-CFFv8GcR.js";import{M as re}from"./mixed-values-hkF2bnrF.js";import"./create-class-name-irFPZBOU.js";import"./get-current-from-ref-J2nPd355.js";import"./no-op-DX6rZLP_.js";import"./is-keycode-character-generating-C88G8DHI.js";const Te={parameters:{fixedWidth:!0},tags:["3"],title:"Components/Textbox Multiline/Underline"},s=function(){const[n,u]=o("");function a(t){const e=t.currentTarget.value;console.log(e),u(e)}return r(l,{onInput:a,value:n,variant:"underline"})},c=function(){const[n,u]=o("");function a(t){const e=t.currentTarget.value;console.log(e),u(e)}return r(l,{...ae(),onInput:a,value:n,variant:"underline"})},i=function(){const[n,u]=o("");function a(t){const e=t.currentTarget.value;console.log(e),u(e)}return r(l,{onInput:a,placeholder:"Placeholder",value:n,variant:"underline"})},d=function(){const[n,u]=o("Text");function a(t){const e=t.currentTarget.value;console.log(e),u(e)}return r(l,{onInput:a,value:n,variant:"underline"})},p=function(){function n(){throw new Error("This function should not be called")}return r(l,{disabled:!0,onInput:n,value:"Text",variant:"underline"})},v=function(){const[n,u]=o(re);function a(t){const e=t.currentTarget.value;console.log(e),u(e)}return r(l,{onInput:a,value:n,variant:"underline"})},V=function(){const[n,u]=o("Text");function a(t){const e=t.currentTarget.value;console.log(e),u(e)}return r(l,{onInput:a,revertOnEscapeKeyDown:!0,value:n,variant:"underline"})},T=function(){const[n,u]=o("Text");function a(e){const w=e.currentTarget.value;console.log(w),u(w)}function t(e){return e!==""}return r(l,{onInput:a,validateOnBlur:t,value:n,variant:"underline"})},g=function(){const[n,u]=o("Text");function a(t){const e=t.currentTarget.value;console.log(e),u(e)}return r(l,{onInput:a,rows:5,value:n,variant:"underline"})},m=function(){const[n,u]=o("Text");function a(t){const e=t.currentTarget.value;console.log(e),u(e)}return r(l,{grow:!0,onInput:a,rows:1,value:n,variant:"underline"})},f=function(){const n=ue(null),[u,a]=o("Text");function t(){if(n.current===null)throw new Error("`ref.current` is `null`");console.log(n.current);const e=n.current.value;console.log(e),a(e)}return r(l,{ref:n,onInput:t,value:u,variant:"underline"})},I=function(){const[n,u]=o("Text");function a(t){console.log(t),u(t)}return r(l,{onValueInput:a,value:n,variant:"underline"})};var x,h,S;s.parameters={...s.parameters,docs:{...(x=s.parameters)==null?void 0:x.docs,source:{originalSource:`function () {
...
}`,...(y=(D=p.parameters)==null?void 0:D.docs)==null?void 0:y.source}}};var F,B,_;v.parameters={...v.parameters,docs:{...(F=v.parameters)==null?void 0:F.docs,source:{originalSource:`function () {
